...
angular.module('govhackFrontendApp')
  .directive('timeseries', function (data) {
    return {
      templateUrl: 'views/timeseries.html',
      restrict: 'E',
      link: function postLink(scope, element, attrs) {
        var timeseries = data.getTimeseries({
           'timeperiod': 'monthly',
           'dataset': 'acorn-sat',
           'site': attrs.siteid,
           'max-temp': true
        ...
        timeseries.$promise.then(function() {
